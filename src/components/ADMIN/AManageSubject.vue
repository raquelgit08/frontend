<template>
  <div class="container-fluid">
    <div class="header-container">
      <h3><i class="bi bi-file-earmark-text-fill"></i>
        Manage Subjects</h3>
    </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="d-flex justify-content-between align-items-center">
            <h5 class="modal-title"><i class="bi bi-file-earmark-text-fill" style="padding-right: 10px;"></i>{{ isEdit ? 'Edit' : 'Add' }} Subject</h5>
